Pod::Spec.new do |s|
  ...
  s.name         = "FAVPlayer"
  s.version      = "1.0.1"
  s.summary      = "A short description of FAVPlayer. FAVPlayer let you play frequency's video natively on iOS and tv"
  ...
  s.license      = "Frequency Licence"
  s.author             = { "clementperez" => "clement@frequency.com" }
  s.ios.deployment_target = '10.0'
  s.tvos.deployment_target = '10.0'
  s.source       = { :git => "https://github.com/ClementPF/FAVplayer.git", :tag => "#{s.version}" }
