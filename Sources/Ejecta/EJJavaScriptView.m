...
- (NSString *)pathForResource:(NSString *)path {
    ...
    return [[NSBundle bundleForClass: EJJavaScriptView.class] pathForResource:path ofType:@""];
    //return [NSString stringWithFormat:@"%@/%@", [NSBundle bundleForClass: EJJavaScriptView.class], path];
}
